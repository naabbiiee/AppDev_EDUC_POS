<?php
  ...
  $ret = "SELECT * FROM pos_admin  WHERE admin_id = '$admin_id'";
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="dashboard.php" >
        <img src="assets/img/brand/brand.png" style="width: 170px; left: 15px; max-height: 80px;" class="navbar-brand-img " alt="...">
      </a>

      <!-- User -->
      <ul class="nav align-items-center d-md-none mt-5">
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav mt--4">
          ...
          <li class="nav-item">
            <a class="nav-link" href="hrm.php">
              <i class="fas fa-user-tie text-dark"></i> HRM
            </a>
          </li>
          <li class="nav-item">
        ...
        <!-- Heading -->
        <h6 class="navbar-heading text-warning">Reporting</h6>
