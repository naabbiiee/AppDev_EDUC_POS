...
if (isset($_POST['pay'])) {
  ...
  if (empty($_POST["pay_code"]) || empty($_POST["pay_amt"]) || empty($_POST['pay_method'])) {
    ...
    $postQuery = "INSERT INTO pos_payments (pay_id, pay_code, order_code, customer_id, pay_amt, pay_method) VALUES(?,?,?,?,?,?)";
    $upQry = "UPDATE pos_orders SET order_status =? WHERE order_code =?";
...
<body>
  ...
  <div class="main-content">
    ...
    $order_code = $_GET['order_code'];
    $ret = "SELECT * FROM  pos_orders WHERE order_code ='$order_code' ";
    ...
    <div style="background-image: url(../assets/background.png); 
                ...
                margin: 0;
                width: 100%;" class="header  pb-8 pt-5 pt-md-8">
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST"  enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="pay" value="Pay Order" class="btn btn-danger text-white" value="">
                  </div>
                </div>
              </form>
            </div>
