...
if (isset($_GET['cancel'])) {
    $id = $_GET['cancel'];
    $adn = "DELETE FROM  pos_orders  WHERE  order_id = ?";
                ...
                <div class="col">
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <a href="orders.php" class="btn btn-outline-primary bg-primary text-white">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    <?php
                                    $ret = "SELECT * FROM  pos_orders WHERE order_status =''  ORDER BY `pos_orders`.`created_at` DESC  ";
