...
<body>
  ...
  <div class="main-content">
        ...
        <div class="header-body">
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-7 mb-x4-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
    ...
    <!-- Page content -->
    <div class="container-fluid mt--7 bg-">
      <div class="row mt-5">
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM  pos_orders ORDER BY `pos_orders`.`created_at` DESC LIMIT 7 ";
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM   pos_payments   ORDER BY `pos_payments`.`created_at` DESC LIMIT 7 ";
                  $stmt = $mysqli->prepare($ret);
                  $stmt->execute();
                  $res = $stmt->get_result();
