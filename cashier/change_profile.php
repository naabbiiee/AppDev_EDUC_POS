...
if (isset($_POST['ChangeProfile'])) {
    ...
    $Qry = "UPDATE pos_staff SET staff_name =?, staff_email =? WHERE staff_id =?";
...
if (isset($_POST['changePassword'])) {
    ...
    if (!$error) {
        $staff_id = $_SESSION['staff_id'];
        $sql = "SELECT * FROM pos_staff   WHERE staff_id = '$staff_id'";
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($old_password != $row['staff_password']) {
                ...
                $query = "UPDATE pos_staff SET  staff_password =? WHERE staff_id =?";
...
<body>
    ...
    <div class="main-content">
        ...
        $ret = "SELECT * FROM  pos_staff  WHERE staff_id = '$staff_id'";
                ...
                <div class="container-fluid d-flex align-items-center">
                    <div class="row">
                        <div class="col-lg-7 col-md-10">
                            <h1 class="display-2 text-white">Hello <?php echo $staff->staff_name; ?></h1>                        </div>
                    </div>
                </div>
            </div>
            <!-- Page content -->
