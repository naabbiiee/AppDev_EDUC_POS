...
--
-- Database: `educational_pos_system`
--
...
-- INSERT INTO `pos_admin` (`admin_id`, `admin_name`, `admin_email`, `admin_password`) VALUES
...
-- INSERT INTO `pos_customers` (`customer_id`, `customer_name`, `customer_phoneno`, `customer_email`, `customer_password`, `created_at`) VALUES
...
-- INSERT INTO `pos_orders` (`order_id`, `order_code`, `customer_id`, `customer_name`, `prod_id`, `prod_name`, `prod_price`, `prod_qty`, `order_status`, `created_at`) VALUES
...
--
-- Table structure for table `pos_pass_resets`
--

CREATE TABLE `pos_pass_resets` (
...
--
-- Dumping data for table `pos_pass_resets`
--

-- INSERT INTO `pos_pass_resets` (`reset_id`, `reset_code`, `reset_token`, `reset_email`, `reset_status`, `created_at`) VALUES
...
-- INSERT INTO `pos_payments` (`pay_id`, `pay_code`, `order_code`, `customer_id`, `pay_amt`, `pay_method`, `created_at`) VALUES
...
-- INSERT INTO `pos_products` (`prod_id`, `prod_code`, `prod_name`, `prod_img`, `prod_desc`, `prod_price`, `created_at`) VALUES
...
-- INSERT INTO `pos_staff` (`staff_id`, `staff_name`, `staff_number`, `staff_email`, `staff_password`, `created_at`) VALUES
...
--
-- Indexes for table `pos_pass_resets`
--
ALTER TABLE `pos_pass_resets`
...
--
-- AUTO_INCREMENT for table `pos_pass_resets`
--
ALTER TABLE `pos_pass_resets`
...
--
ALTER TABLE `pos_orders`
  ADD CONSTRAINT `CustomerOrder` FOREIGN KEY (`customer_id`) REFERENCES `pos_customers` (`customer_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ProductOrder` FOREIGN KEY (`prod_id`) REFERENCES `pos_products` (`prod_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
