            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  ...
                  $ret = "SELECT * FROM  pos_orders WHERE customer_id = '$customer_id' ORDER BY `pos_orders`.`created_at` DESC LIMIT 10 ";
          ...
          <div class="card shadow">
            ...
            <div class="table-responsive">
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <?php
                  $ret = "SELECT * FROM   pos_payments WHERE customer_id ='$customer_id'   ORDER BY `pos_payments`.`created_at` DESC LIMIT 10 ";
                  $stmt = $mysqli->prepare($ret);
                  $stmt->execute();
                  $res = $stmt->get_result();
