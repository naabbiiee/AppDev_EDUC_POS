...
if (isset($_POST['addCustomer'])) {
    ...
    if (empty($_POST["customer_phoneno"]) || empty($_POST["customer_name"]) || empty($_POST['customer_email']) || empty($_POST['customer_password'])) {
        ...
        $postQuery = "INSERT INTO pos_customers (customer_id, customer_name, customer_phoneno, customer_email, customer_password) VALUES(?,?,?,?,?)";
                    ...
                    <div class="card bg-secondary shadow border-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            <form method="post" role="form">
                                ...
                                <div class="form-group">
                                    <div class="text-center">
                                        <button type="submit" name="addCustomer" class="btn btn-primary my-4 text-dark">Create Account</button>
                                        <a href="index.php" class="btn btn-success text-right text-dark">Log In</a>
                                    </div>
                                </div>
                            </form>
