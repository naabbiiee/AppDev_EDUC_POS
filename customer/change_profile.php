...
if (isset($_POST['ChangeProfile'])) {
  ...
  if (empty($_POST["customer_phoneno"]) || empty($_POST["customer_name"]) || empty($_POST['customer_email'])) {
    ...
    $postQuery = "UPDATE pos_customers SET customer_name =?, customer_phoneno =?, customer_email =?, customer_password =? WHERE  customer_id =?";
...
if (isset($_POST['changePassword'])) {
    ...
    if (!$error) {
        $customer_id = $_SESSION['customer_id'];
        $sql = "SELECT * FROM pos_customers   WHERE customer_id = '$customer_id'";
        ...
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($old_password != $row['customer_password']) {
                ...
                //Insert Captured information to a database table
                $query = "UPDATE pos_customers SET  customer_password =? WHERE customer_id =?";
...
<body>
    ...
    <div class="main-content">
        ...
        $ret = "SELECT * FROM  pos_customers  WHERE customer_id = '$customer_id'";
        ...
        ?>
            <!-- Header -->
            <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(assets/img/theme/restro00.png); background-size: cover; background-position: center top;">
                <!-- Mask -->
